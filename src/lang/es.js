export const textEs = {
    ...
    consulting:
      "Evaluamos su situación actual, definimos una hoja de ruta estratégica, brindamos soluciones técnicas y un plan de implementación. También brindamos capacitación para garantizar una adopción exitosa.",
    SoftwareDevelopmentTitle: "Desarrollo de Software",
    SoftwareDevelopment:
      "Diseñamos e implementamos soluciones de software personalizadas para mejorar sus operaciones.",
    ongoingSuportTitle: "Soporte Continuo",
    ongoingSuport:
      "Garantizamos el óptimo funcionamiento de sus sistemas con mantenimiento, actualizaciones y asistencia permanente.",
    ...
    comprehensiveSupportTitle: "Soporte Integral",
    comprehensiveSupport:
      "Proporcionamos orientación paso a paso durante todo el proceso para garantizar el éxito.",
    knowladgeTransferTitle: "Transferencia de Conocimientos",
    knowladgeTransfer:
      "Capacitamos a su personal para optimizar el uso de nuestras soluciones.",
